...
public class Song
{
    ...
    public Song(String name, String artist, String album, String inputLength, String spotifyID, ArrayList<Boolean> tagData)
    {
        ...
        boolean nameQuotes = name.indexOf("~~") > 0;
        boolean nameCommas = name.indexOf("@") > 0;
        boolean artistCommas = artist.indexOf("@") > 0;
        boolean albumCommas = album.indexOf("@") > 0;
        if(nameQuotes)
        {
